...
//
//  nenad pekez, 21.11.2023 , prema poslednjim izmenama sa sajta MUP-a
////////////////////////////////////////////////////////////////////////////
unit CelikApi;
...
type
  ...
  tagEID_DOCUMENT_DATA = record
    ...
    issuingAuthoritySize: Integer;
	  documentSerialNumber: array[0..EID_MAX_DocumentSerialNumber - 1] of AnsiChar;
	  documentSerialNumberSize: Integer;
	  chipSerialNumber: array[0..EID_MAX_ChipSerialNumber - 1] of AnsiChar;
  ...
  tagEID_FIXED_PERSONAL_DATA = record
    ...
    communityOfBirthSize: Integer;
 	  statusOfForeigner: array[0..EID_MAX_StatusOfForeigner - 1] of AnsiChar;
	  statusOfForeignerSize: Integer;
    nationalityFull: array[0..EID_MAX_NationalityFull - 1] of AnsiChar;
